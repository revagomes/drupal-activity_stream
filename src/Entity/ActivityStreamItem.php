...
use Drupal\activitystream\ActivityStreamItemAccessControlHandler;
use Drupal\activitystream\ActivityStreamItemListBuilder;
use Drupal\activitystream\Form\ActivityStreamItemForm;

/**
 * Defines the Activity Stream item entity type.
 */
#[ContentEntityType(
  id: 'activitystream_item',
  ...
  base_table: 'activitystream_item',
  entity_keys: [
    'id' => 'id',
    'label' => 'title',
    'langcode' => 'langcode',
  ...
  links: [
    'canonical' => '/activitystream/{activitystream_item}',
    'edit-form' => '/activitystream/{activitystream_item}/edit',
    'delete-form' => '/activitystream/{activitystream_item}/delete',
    'collection' => '/admin/content/activitystream',
  ],
  admin_permission: 'administer activitystream',
)]
class ActivityStreamItem extends ContentEntityBase implements ActivityStreamItemInterface {
  ...
  public function getLink(): string {
    return (string) $this->get('activitystream_link')->value;
  }
  ...
  public function getGuid(): string {
    return (string) $this->get('activitystream_guid')->value;
  }
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type): array {
    ...
    // External link URL.
    $fields['activitystream_link'] = BaseFieldDefinition::create('uri')
    ...
    $fields['activitystream_guid'] = BaseFieldDefinition::create('string')
    ...
    $fields['activitystream_raw'] = BaseFieldDefinition::create('string_long')
    ...
    // Body content.
    $fields['activitystream_body'] = BaseFieldDefinition::create('text_long')

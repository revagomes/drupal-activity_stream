...
class SettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state): array {
    ...
    $form['bearer_token'] = [
      ...
      '#description' => $this->t('App-only Bearer token from the <a href=":url">X Developer Portal</a>. Grants read access to public posts via the search endpoint.', [':url' => 'https://developer.x.com/en/portal/dashboard']),
      '#required' => TRUE,
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state): void {
    $this->config('actstream_twitter_search.settings')
